...
public class homePage extends BaseTest {
	...
	@AndroidFindBy(id=homepageLocator.txt_control_town_id)
	public MobileElement txt_control_town_id;
	
	@AndroidFindBy(id=homepageLocator.txt_control_region_id)
	public MobileElement txt_control_region_id;
	
	public void delivery_select() 
	{
		drpdownlst_method_of_delivery_id.click();
