...
public class promotionscreenPage{
	...
	public static MobileElement btn_enter_xpath;
	
	@AndroidFindBy(xpath=promotionscreenLocator.txt_next_xpath)
	public static MobileElement txt_next_xpath;
	
	@AndroidFindBy(xpath=promotionscreenLocator.txt_close_xpath)
	public static MobileElement txt_close_xpath;
